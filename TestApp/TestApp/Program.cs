...
namespace TestApp
{
    class Program
    {
        static void Prepare()
        {
            ...
            var DefaultCert_2048 = new X509Certificate2(Convert.FromBase64String(DefaultX509Data_2048));
            ...
            var DefaultAsymmetricCert_2048 = new X509Certificate2(Convert.FromBase64String(DefaultX509Data_2048));
            ...
            SecurityTokenDescriptor descriptor = new SecurityTokenDescriptor()
            {
                Issuer = "issuer",
                Audience = "audience",
                SigningCredentials = DefaultSymmetricSigningCreds_256_Sha2
            };
